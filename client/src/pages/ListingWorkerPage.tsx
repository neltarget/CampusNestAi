      ...
      {result && (
        <div className="mt-6 rounded-xl border border-gray-200 bg-white p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              <label className="text-xs font-medium text-gray-500">WiFi</label>
              <p className="mt-1 text-sm text-gray-900">
                {result.wifi ? "Yes" : "No"}
              </p>
            </div>
            <div>
              ...
              <p className="mt-1 text-sm text-gray-900">{result.bathrooms}</p>
            </div>
            <div>
              <label className="text-xs font-medium text-gray-500">Kitchen</label>
              <p className="mt-1 text-sm text-gray-900">
